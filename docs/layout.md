...
`[display]` selects the target monitor, active named layout, wallpaper, placement, and optional explicit render scale. Runtime display scale resolution rounds to three decimal places before sizing the dashboard.
