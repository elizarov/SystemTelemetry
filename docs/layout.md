...
- `[gauge]`: `preferred_size`, `outer_padding`, `min_radius`, `ring_thickness`, `start_angle_degrees`, `sweep_degrees`, `segment_count`, `segment_gap_degrees`, `text_half_width`, `value_top`, `value_bottom`, `label_top`, `label_bottom`
