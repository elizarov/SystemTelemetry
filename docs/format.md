...
- Separate multi-line type aliases and multi-line list-initialized field declarations from neighboring declarations with one empty line, even when the neighbors are also fields. Multi-line constant assignments stay in their field group unless the source contains an empty-line separator.
