...
- Metric-list rows can show a small right-aligned muted annotation above the bar when the resolved metric supplies one; `gpu.fps` uses this annotation for the cleaned presenting application name.
