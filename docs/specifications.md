...
- While layout-edit mode is active, the renderer shows container guides, a thin single-line outline around the hovered widget or hovered card title, supported widget-local guides, and matching edit cursors.
