...
- Throughput circular size anchors must render as standalone circles without a dotted projected target rectangle, and their interactive region must stay at the circle plus the same slightly padded handle hit box used by other anchors.
