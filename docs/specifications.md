...
- Dashboard hit-testing treats the editor as covering the dashboard only when the editor is actually above the dashboard in window Z-order, not merely because the windows overlap on screen.
