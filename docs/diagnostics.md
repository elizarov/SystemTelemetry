...
- App-icon exports use the same programmatic icon renderer as the live window, tray, and dialog icons, and use the current resolved theme colors without depending on dashboard render scale.
