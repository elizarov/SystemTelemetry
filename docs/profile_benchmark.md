...
- Measure formatter golden throughput with `build\CaseDashBenchmarks.exe format-golden 20 2`; the benchmark formats `tools\tests\format\src\format_test_input.cpp` in memory and reports total plus per-iteration time without file writes.
