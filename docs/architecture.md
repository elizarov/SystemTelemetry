...
- Vendor providers extend that collector with AMD and NVIDIA GPU support plus the Gigabyte board-metric path without changing the renderer-facing snapshot model.
