...
- `lint.cmd` enforces the util, config, renderer, telemetry, widget, layout-model, dashboard-renderer, layout-edit, and renderer-only D2D rules through the source dependency graph before reporting success.
