...
- `src/diagnostics/` contains diagnostics session and headless-run orchestration, command-line option parsing, default diagnostics output filenames, snapshot dump I/O, app-icon PNG export support, and diagnostics-owned support modules.
