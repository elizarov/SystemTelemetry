...
- Hover titlebar monitor-fit checks protect the top and side edges where the added chrome appears; bottom overflow caused by an oversized dashboard placement does not decide whether the titlebar can be shown.
