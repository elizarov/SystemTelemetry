...
- `DashboardApp` owns active autohide drawer state, including exact placement-target eligibility, topmost state, hidden-edge pointer polling, close-delay timing, native slide show or hide animation, and titlebar suppression while autohide is active.
