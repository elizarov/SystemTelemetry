...
- Own strict console-only command-line shape validation and usage help for `CaseDashHeadless.exe`, keeping that text out of the shipped dashboard executable.
