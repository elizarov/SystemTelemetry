...
- Own the cross-thread layer bitmap pool: the main thread acquires writable layer bitmaps before drawing, while the render thread returns superseded active or pending frame layers after they are no longer presented.
