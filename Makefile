...
SRC=src\main.cpp src\config.cpp src\telemetry.cpp src\gpu_vendor.cpp src\gpu_amd_adl.cpp src\utf8.cpp src\vendor\adlx\SDK\ADLXHelper\Windows\Cpp\ADLXHelper.cpp src\vendor\adlx\SDK\Platform\Windows\WinAPIs.cpp
