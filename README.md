CaseDash is a compact Windows 11 dashboard for an 800x480 secondary display. It presents CPU, GPU, memory, network, storage, and time data in a high-contrast Win32 interface designed for always-on glanceability.
